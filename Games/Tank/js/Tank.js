...
OregonH.Tank.init = function (stats) {
    this.day = stats.day;
...
OregonH.Tank.updateWeight = function () {
    var droppedFood = 0;
    var droppedGuns = 0;

    //how much can the Tank carry
...
OregonH.Tank.updateDistance = function () {
...
//food consumption
OregonH.Tank.consumeFood = function () {
